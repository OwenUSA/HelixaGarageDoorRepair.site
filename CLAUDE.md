# CLAUDE.md — Helixa Garage Door Repair, clone-and-adapt build chain
...
MAP_COORDS         = 32.6130,-83.6241
HOURS              = 7 days, 7:00 AM – 7:00 PM
SERVICE_AREA       = Serving Warner Robins and the middle Georgia corridor.
...
the coordinates are real Warner Robins, GA coordinates and the map is embedded by coordinates
...
- **Proposition category** (Prompt 3, item 3): **transparency — you are told what is wrong and why.**
